...
public class PlazaVO {
    ...
    public PlazaVO(int num_Plaza, double tarifa, boolean estado_Plaza, int tipo_Plaza) {
    ...
    public boolean isEstado_Plaza() {
        return estado_Plaza;
    }

    public void setEstado_Plaza(boolean estado_Plaza) {
        this.estado_Plaza = estado_Plaza;
    }
